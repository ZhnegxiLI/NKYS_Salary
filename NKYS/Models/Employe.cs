...
namespace NKYS.Models
{
    public class Employe: BaseObject
    {
        ...
        public Employe()
        {
            this.EmployeDeductionConfigurations = new List<EmployeDeductionConfiguration>();
        }
        ...
        public List<EmployeDeductionConfiguration> EmployeDeductionConfigurations { get; set; }

        [NotMapped]
        public EmployeDeductionConfiguration EmployeDeductionConfiguration { get; set; }
    }
}
